    ...
    public partial class BudgetPurpose : Form
    {
        ...
        private void DGVAccounts_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                comboSL2.SelectedValue = Convert.ToInt32(DGVAccounts.Rows[e.RowIndex].Cells[].FormattedValue.ToString());
                //comboSL3.SelectedValue = Convert.ToInt32(DGVAccounts.Rows[e.RowIndex].Cells[1].FormattedValue.ToString());
