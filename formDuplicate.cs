...
namespace MANUUFinance
{
    public partial class formDuplicate : Form
    {
        ...
        public formDuplicate(int userId, int deptId, int roleId, string formName)
        {
            InitializeComponent();
            this.userId = userId;
            this.deptId = deptId;
        ...
        {
            // TODO: This line of code loads data into the 'financeDataSet22.BillMst' table. You can move, or remove it, as needed.
            this.billMstTableAdapter2.Fill(this.financeDataSet22.BillMst);
            txtPKBillID.Text = "0";
